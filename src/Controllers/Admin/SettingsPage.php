...
class SettingsPage extends AbstractController
{
    public function registerPage()
    {
        ...
        add_options_page(
            ...
            PLUGIN_BUILDER_NAME.'settings-page', // slug (needs to be unique)
    ...
    public function registerSettings()
    {
        ...
        add_option(PLUGIN_BUILDER_NAME.'_id_number');
        add_option(PLUGIN_BUILDER_NAME.'_title');
        ...
        register_setting(
            PLUGIN_BUILDER_NAME.'_options',      // Option group; Default whitelisted option listed on URL above
            PLUGIN_BUILDER_NAME.'_id_number',    // ID
            [
                'type' => 'number',
        ...
        add_settings_section(
            PLUGIN_BUILDER_NAME.'_options_section',  // Unique ID for the section
            'Section Title',                        // Title for the section
            [$this, 'renderSectionIntro'],          // Callable function to echo the intro
            PLUGIN_BUILDER_NAME.'settings-page'      // the page this section appears on (defined in registerPage above)
        );
        ...
        add_settings_field(
            PLUGIN_BUILDER_NAME.'_id_number',        // id="" value
            'Example ID number',                    // <label> vale
            [$this, 'renderField'],                 // callback to actually do the rendering of the input
            PLUGIN_BUILDER_NAME.'settings-page',     // Slug of the page to show this on (defined in registerPage above)
            PLUGIN_BUILDER_NAME.'_options_section',  // slug of the sction the field appears in
            [                                       // array of values to pass to the render callback
                'id' => PLUGIN_BUILDER_NAME.'_id_number',
                'type' => 'number',
            ]
        );

        add_settings_field(
            PLUGIN_BUILDER_NAME.'_title',            // id="" value
            'Example Title',                        // <label> vale
            [$this, 'renderField'],                 // callback to actually do the rendering of the input
            PLUGIN_BUILDER_NAME.'settings-page',     // Slug of the page to show this on (defined in registerPage above)
            PLUGIN_BUILDER_NAME.'_options_section',  // slug of the sction the field appears in
            [                                       // array of values to pass to the render callback
                'id' => PLUGIN_BUILDER_NAME.'_title',
                'type' => 'text',
            ]
        );
    }
    ...
    {
        echo __('Enter your settings below:', PLUGIN_BUILDER_NAME);
    }
